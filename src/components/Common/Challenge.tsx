    ...
    <section className={`${padding} ${bgColor}`}>
      <div className="max-w-[1500px] mx-auto px-6 lg:px-8">
        ...
        <div className="mb-12">
          ...
          <h2 className={`${titleSize} font-['Roboto'] ${textColor} mb-5 leading-tight`}>
            {title}
          </h2>
        ...
        <div className={`grid ${gridCols} ${gap}`}>
          {challenges.map((challenge) => (
            ...
            >
              <div className={`w-8 h-0.5 ${accentColor.replace('text-', 'bg-')} mb-5`}></div>
              <h3 className={`font-semibold ${textColor} text-base mb-3 leading-snug`}>
                {challenge.title}
              </h3>
